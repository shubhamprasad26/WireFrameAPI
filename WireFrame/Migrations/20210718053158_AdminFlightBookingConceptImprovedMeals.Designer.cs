...
namespace WireFrame.Migrations
{
    ...
    [Migration("20210718053158_AdminFlightBookingConceptImprovedMeals")]
    partial class AdminFlightBookingConceptImprovedMeals
    {
            ...
            modelBuilder.Entity("WireFrames.Model.FlightInfo", b =>
                {
                    ...
                    b.Property<int?>("scheduleDatesId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WireFrames.Model.FlightInfo", b =>
                {
                    ...
                    b.HasOne("WireFrames.Model.ScheduleType", "scheduleDates")
                        .WithMany()
                        .HasForeignKey("scheduleDatesId");
